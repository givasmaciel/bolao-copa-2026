...
- **Ranking** — inclui pontos extras via subquery; desempate por mais palpites com pontos > 0; exclui admins; colunas Dif. Líder e Média pts/palpite (sobre finalizados); barra visual proporcional ao líder; banner com "🏆 Líder + 🎯 Mais palpites pontuados + 🔥 Maior pontuação em 1 jogo + 📊 Média pts/palpite"; coluna Palpites exibida como "finalizados/total" para evitar confusão entre jogos finalizados e pendentes
